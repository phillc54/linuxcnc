...
static inline void print_json5_PmCartesian_(const char *varname, PmCartesian value)
{
    ...
    rtapi_print_with_indent("%s: [%0.17g, %0.17g, %0.17g],%c", varname ?: "NO_NAME", value.x, value.y, value.z, line_brk);
}

static inline void print_json5_PmVector_(const char *varname, PmVector value)
{
    rtapi_print_with_indent("%s: [%0.17g, %0.17g, %0.17g, %0.17g, %0.17g, %0.17g, %0.17g, %0.17g, %0.17g],%c",
                    varname,
                    value.ax[0],
                    value.ax[1],
                    value.ax[2],
...
static inline void print_json5_PmCartLine_(const char *name, PmCartLine value)
{
    ...
    print_json5_PmCartesian_("end", value.end);
...
static inline void print_json5_PmLine9_(const char *name, PmLine9 const *line)
{
    print_json5_object_start_(name);
    print_json5_PmVector_field(line, start);
    print_json5_PmVector_field(line, end);
    print_json5_PmVector_field(line, uVec);
    print_json5_double_field(line, tmag);
    print_json5_object_end_();
}

static inline void print_json5_PmCircle9_(const char *name, PmCircle9 const *circ)
{
    print_json5_object_start_(name);
    print_json5_PmCircle_field(circ, xyz);
    print_json5_PmCartLine_field(circ, abc);
    print_json5_PmCartLine_field(circ, uvw);
    print_json5_double_field(circ, xyz_ratio);
    print_json5_double_field(circ, abc_ratio);
    print_json5_double_field(circ, uvw_ratio);
    print_json5_object_end_();
}
...
static inline void print_json5_blend_boundary_t(const char *fname, blend_boundary_t const * const r)
{
    ...
    print_json5_double_field(r, prev_len);
    print_json5_object_end_();
}
...
static inline void print_json5_biarc_control_points_t(const char *fname, biarc_control_points_t const * const c)
{
    ...
    print_json5_double_field(c, d1);
    print_json5_double_field(c, d2);
    print_json5_object_end_();
}
...
{
    print_json5_object_start_(fname);
    print_json5_double_field(r, deviation_margin);
...
static inline void print_json5_biarc_solution_t(const char *fname, biarc_solution_t const * const r)
{
    ...
    print_json5_double_field(r, R_geom_est);
...
static inline void print_json5_SphericalArc9(const char *fname, SphericalArc9 const * const arc) {
    print_json5_object_start_(fname);
    print_json5_PmVector_("arc_start", arc->start);
    print_json5_PmVector_("arc_end", arc->end);
...
static inline void print_json5_TC_STRUCT_kinematics(const char *fname, TC_STRUCT const * const tc)
{
    ...
    print_json5_int_field(tc, accel_mode);
    ...
    print_json5_double_field(tc, currentvel);
    print_json5_int_field(tc, motion_type);
    print_json5_object_end_();
}

static inline void print_json5_TC_STRUCT_geometry(const char *fname, TC_STRUCT const * const tc)
{
    print_json5_object_start_(fname);
    print_json5_double_("motion_type", tc->motion_type);
    switch (tc->motion_type) {
    case TC_LINEAR:
        print_json5_PmLine9_("line", &tc->coords.line);
        break;
    case TC_CIRCULAR:
        print_json5_PmCircle9_("circle", &tc->coords.circle);
        break;
    case TC_SPHERICAL:
        print_json5_SphericalArc9("arc", &tc->coords.arc);
        break;
    case TC_RIGIDTAP:
        print_json5_PmCartLine_("rigidtap_nominal", tc->coords.rigidtap.nominal_xyz);
        print_json5_PmCartLine_("rigidtap_nominal", tc->coords.rigidtap.actual_xyz);
        print_json5_double_field(tc, coords.rigidtap.tap_uu_per_rev);
        print_json5_double_field(tc, coords.rigidtap.retract_uu_per_rev);
