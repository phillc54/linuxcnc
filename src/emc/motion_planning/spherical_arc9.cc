    ...
    PmVector const * const uTan)
{
    ...
    arc->rStart = VecVecSub(*start, center);
    arc->rEnd = VecVecSub(*end, center);
    ...
    PmVector u0 = VecScalMult(arc->rStart, 1.0 / radius0);
    PmVector u1 = VecScalMult(arc->rEnd, 1.0 / radius1);
...
CircleAccLimits arc9AccLimit(double eff_radius,
    double v_max,
    double a_max)
{
