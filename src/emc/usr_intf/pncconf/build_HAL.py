...
#*******************
    ...
    def qtplasmac_connections(self, file, base):
        ...
        # check for ohmic sensing with a relay
        pinname = self.a.make_pinname(self.a.findsignal("plasmac:ohmic-sense-in-b"), substitution = self.d.useinisubstitution)
        if pinname:
            vscale = 1
            voffset = 0
            print("\n# ---OHMIC SENSE RELAY---", file=file)
            print("setp plasmac.ohmic-sense-mode 0", file=file)
    ...
    def plasmac_ohmic_sense(self, f1):
        print("\n# ---OHMIC SENSE RELAY DEBOUNCE---", file=f1)
