...
/* global error number and errors */
    ...
    typedef enum {
        PM_NULL_ERR = -5, /* divide by zero error */
...
/* NOTE:  only Cartesian type supported in C now */
    ...
    extern double pmCartAbsMax(PmCartesian const * const v);
...
/* circle functions */
    ...
    extern int pmCircleVerifyEnd(const PmCircle * circle, const PmCartesian * end);
