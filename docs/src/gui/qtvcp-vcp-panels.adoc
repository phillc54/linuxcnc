...
The advantage of using panels is that it separates your custom display code from the core code so upgrading the system will not break your customization.
...
* Connect the input pins in your postgui HAL file.
...
* Copy the files located in the panel to:
...
# connect pins
net bit-input1     test_panel.checkbox_1
net bit-hide       test_panel.checkbox_4

net bit-output1    test_panel.led_1

net s32-in1        test_panel.doublescale_1-s
